...
void color_control::do_some_magic( cv::InputOutputArray img, int red, int green, int blue, int tolerance) {
    ...
    center.x = S_x;
    center.y = S_y;
    cv::circle( img, center, radius, CV_RGB( 255 - red, 255 - green, 255 - blue ) , 3, 8, 0 );

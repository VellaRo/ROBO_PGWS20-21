...
void Mystery_mover::mainLoop() {
	...
	while (m_nodeHandle.ok())
	{
	   ...
	   /* Plan  */
		...
		ROS_INFO(" robo_AMCL_Test commands:forward speed=%f[m/sec] and turn speed =%f[rad/sec]", 
...
int main(int argc, char** argv) {
	...
	// get an object of type Breitenberg and call it robbi
	Mystery_mover robbi;
...
// end of file: robo_AMCL_Test.cpp

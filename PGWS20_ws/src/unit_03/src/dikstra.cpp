...
list<vertex_t> dikstra_main(int start_knoten, int ziel_knoten){
    ...
    adjacency_list[18].push_back(neighbor(6, 1));
    adjacency_list[6].push_back(neighbor(18, 1));
    ...
    adjacency_list[22].push_back(neighbor(2, 1));
    adjacency_list[2].push_back(neighbor(22, 1));
    adjacency_list[22].push_back(neighbor(23, 1));
    adjacency_list[23].push_back(neighbor(1, 1));
    adjacency_list[1].push_back(neighbor(23, 1));
    ...
    adjacency_list[41].push_back(neighbor(1, 1));
